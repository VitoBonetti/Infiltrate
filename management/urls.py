...
urlpatterns = [
    ...
    path('users/', UserListView.as_view(), name='mng_users'),
    path('users/form/', UserFormView.as_view(), name='mng_user_form'),
    path('users/<uuid:user_id>/roles/', UserRoleView.as_view(), name='mng_user_roles'),
